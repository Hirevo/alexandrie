...
fn main() {
    let syntaxes = {
        ...
        builder.add_from_folder("syntect-syntaxes", true).expect("couldn't load syntaxes");
        builder.build()
    };
    ...
    dumps::dump_to_file(&syntaxes, "syntect-dumps/syntaxes.dump").expect("couldn't emit syntaxes' dump");
